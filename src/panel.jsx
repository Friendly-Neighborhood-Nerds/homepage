    ...
    return (
        ...
        <div class="w-40 sm:w-72 -ml-10 relative">
          ...
          <div class="-skew-x-15 w-full overflow-hidden relative" >
            <div class="skew-x-15 bg-cover bg-center w-full h-60 ml-10 my-3 mr-auto shadow-lg"  style={{ "background-image": `url(./public/images/backgrounds/bg-${textColor.split("-")[1]}.jpg)` }} />
          </div>
        </div>
    ...
    return(<article class="w-full flex justify-center mx-5 my-7">
        <div class="sm:w-96 w-60 overflow-hidden mt-5 z-20">
          ...
          <div class="w-40 sm:w-72 sm:-ml-10 -ml-9 relative">
            <img src={`./public/images/nerds/${panel().id}.png`} class="absolute right-0 bottom-8 z-10 sm:max-h-11/10 max-h-75/100 max-w-52 sm:max-w-72"></img>
